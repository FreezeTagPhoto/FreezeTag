...
// 	id, err := mgr.AlbumDB.GetAlbumByName("missing-album", user)
// 	require.NoError(t, err)
...
// 	found, err := mgr.AlbumDB.GetAlbumByName("lookup-private-grant", viewer)
// 	require.NoError(t, err)
...
// 	found, err := mgr.AlbumDB.GetAlbumByName("lookup-private-denied", viewer)
// 	require.NoError(t, err)
// 	assert.Equal(t, Album{}, found)
// }
...
// 	found, err := mgr.AlbumDB.GetAlbumByName("lookup-public-hidden", viewer)
// 	require.NoError(t, err)
// 	assert.Equal(t, Album{}, found)
// }
...
// 	found, err := mgr.AlbumDB.GetAlbumByName("same-name", viewer)
// 	require.NoError(t, err)
